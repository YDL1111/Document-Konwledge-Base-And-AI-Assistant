...
import com.docbase.common.constant.Constants.Captcha;
...
import com.docbase.common.utils.i18n.MessageUtils;
import com.docbase.domain.common.cache.GuavaCacheService;
import com.docbase.domain.common.cache.MapCache;
...
public class LoginService {
    ...
    public ConfigDTO getConfig() {
        ...
        configDTO.setIsRegisterEnabled(isRegisterEnabled());
    ...
    public CaptchaDTO generateCaptchaImg() {
        ...
        if (isCaptchaOn) {
            ...
            // 生成验证码
            String captchaType = DocBaseConfig.getCaptchaType();
    ...
    public void recordLoginInfo(SystemLoginUser loginUser) {
        ...
        entity.setLoginIp(resolveClientIp());
        entity.setLoginDate(DateUtil.date());
        entity.updateById();
    }

    public String decryptPassword(String originalPassword) {
        byte[] decryptBytes = SecureUtil.rsa(DocBaseConfig.getRsaPrivateKey(), null)

package com.docbase.admin.controller.system;
...
import com.docbase.common.utils.poi.CustomExcelUtil;
import com.docbase.domain.common.command.BulkOperationCommand;
import com.docbase.domain.system.user.UserApplicationService;
...
public class SysUserController extends BaseController {
    ...
    @GetMapping
    public ResponseDTO<PageDTO<UserDTO>> userList(@P("query") SearchUserQuery<SearchUserDO> query) {
    ...
    @PostMapping
    public ResponseDTO<Void> add(@P("command") @Validated @RequestBody AddUserCommand command) {
        userApplicationService.addUser(command);
        return ResponseDTO.ok();
    }
    ...
    @PutMapping("/{userId}")
    public ResponseDTO<Void> edit(@P("command") @Validated @RequestBody UpdateUserCommand command) {
    ...
    public ResponseDTO<Void> remove(@P("userIds") @PathVariable List<Long> userIds) {
    ...
    public ResponseDTO<Void> changeStatus(@PathVariable Long userId, @P("command") @RequestBody ChangeStatusCommand command) {
        command.setUserId(userId);

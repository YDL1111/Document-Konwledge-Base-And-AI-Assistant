package com.docbase.domain.system.user;

import cn.hutool.core.convert.Convert;
import com.docbase.common.core.page.PageDTO;
import com.docbase.domain.common.cache.CacheCenter;
import com.docbase.domain.common.command.BulkOperationCommand;
import com.docbase.domain.common.dto.CurrentLoginUserDTO;
import com.docbase.domain.system.post.dto.PostDTO;
import com.docbase.domain.system.role.dto.RoleDTO;
import com.docbase.domain.system.user.command.AddUserCommand;
import com.docbase.domain.system.user.command.ChangeStatusCommand;
import com.docbase.domain.system.user.command.ResetPasswordCommand;
import com.docbase.domain.system.user.command.UpdateProfileCommand;
import com.docbase.domain.system.user.command.UpdateUserAvatarCommand;
import com.docbase.domain.system.user.command.UpdateUserCommand;
import com.docbase.domain.system.user.command.UpdateUserPasswordCommand;
import com.docbase.domain.system.user.db.SearchUserDO;
import com.docbase.domain.system.user.dto.UserDTO;
import com.docbase.domain.system.user.dto.UserDetailDTO;
import com.docbase.domain.system.user.dto.UserProfileDTO;
import com.docbase.domain.system.user.model.UserModel;
import com.docbase.domain.system.user.model.UserModelFactory;
import com.docbase.domain.system.user.query.SearchUserQuery;

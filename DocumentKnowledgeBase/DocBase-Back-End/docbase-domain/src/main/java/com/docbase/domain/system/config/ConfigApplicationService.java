package com.docbase.domain.system.config;

import com.docbase.common.core.page.PageDTO;
import com.docbase.domain.common.cache.CacheCenter;
import com.docbase.domain.system.config.command.ConfigUpdateCommand;
import com.docbase.domain.system.config.dto.ConfigDTO;
import com.docbase.domain.system.config.model.ConfigModel;
import com.docbase.domain.system.config.model.ConfigModelFactory;
import com.docbase.domain.system.config.query.ConfigQuery;

...
import com.docbase.infrastructure.exception.GlobalExceptionFilter;
import com.docbase.infrastructure.filter.TestFilter;
import com.docbase.infrastructure.filter.TraceIdFilter;
...
public class FilterConfig {
    ...
    @Value("${docbase.traceRequestIdKey}")

package com.docbase.common.config;
...
public class DocBaseConfig {
    ...
    public void setFileBaseDir(String fileBaseDir) {
        DocBaseConfig.fileBaseDir = fileBaseDir  + File.separator + Constants.RESOURCE_PREFIX;
    }
    ...
    public void setApiPrefix(String apiDocsPathPrefix) {
        DocBaseConfig.apiPrefix = apiDocsPathPrefix;
    }
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        DocBaseConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        DocBaseConfig.captchaType = captchaType;
    }
    ...
    public void setRsaPrivateKey(String rsaPrivateKey) {
        DocBaseConfig.rsaPrivateKey = rsaPrivateKey;
    }
    ...
    public void setDemoEnabled(boolean demoEnabled) {
        DocBaseConfig.demoEnabled = demoEnabled;
    }
